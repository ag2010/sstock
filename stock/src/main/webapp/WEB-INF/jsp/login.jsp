...
<head>
    ...
    <link rel="icon" href="uiloader/static/little.ico" type="image/x-icon"/>
    <title>库存管理系统登录页</title>
    <meta name="keywords" content="库存管理系统登录页">
    <meta name="description" content="库存管理系统登录页。">
</head>
<body>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8">
                    <input id="username" name="username" type="text" placeholder="请输入登录账号"
                           class="input-text size-L validate[required,custom[onlyLetterSp]]">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-3"><i class="Hui-iconfont">&#xe60e;</i></label>
...
<div class="footer">Copyright 上海莹地购网络科技有限公司</div>
