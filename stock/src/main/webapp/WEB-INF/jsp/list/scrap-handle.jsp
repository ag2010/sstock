    ...
    <form action="" method="post" class="form form-horizontal" id="form-role-add">
        <div class="row cl">
            <div class="row col-xs-4 col-sm-4  input_bar">
                ...
                <div class="row col-xs-7 col-sm-7 ">
                    <input type="text" class="input-text" value="${scrap.id}" placeholder="" id="id" name="id">
                </div>
            </div>
            <div class="row col-xs-4 col-sm-4  input_bar">
                ...
                <div class="row col-xs-7 col-sm-7 ">
                    <input type="text" onfocus="WdatePicker()" class="input-text Wdate"
                           value="<fmt:formatDate value="${scrap.scrapTime}" pattern="yyyy-MM-dd"/>" placeholder=""
        ...
        <div class="row cl">
            ...
            <div class="row col-xs-4 col-sm-4  input_bar">
                ...
                <div class="row col-xs-7 col-sm-7 ">
                    <input type="text" class="input-text" value="${scrap.procurementId}" placeholder=""
        ...
        <div class="row cl">
            ...
            <div class="row col-xs-9 col-sm-9 input_bar">
                <textarea id="remark" name="remark" placeholder="备注" rows="4"
                          style="width:100%;margin-left: 15px;">${scrap.remark}</textarea>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        var url = "${context_root}/list/getScrapOrderInfo.action?id=" + GetQueryString('id');
    ...
    $("#form-role-add").validate({
        ...
        submitHandler: function (form) {
            ...
            $.ajax({
                url: "${context_root}/list/checkScrap.action",
                type: 'post',
                async: true,
                cache: false,
                data: $(form).serialize(),
