    ...
    <form action="" method="post" class="form form-horizontal" id="form-role-add">
        <div class="row cl">
            <div class="row col-xs-4 col-sm-4  input_bar">
                <label class="form-label col-xs-4 col-sm-4"> 采购单 </label>
                <div class="row col-xs-7 col-sm-7 ">
                    <input type="text" class="input-text" value="${procurement.id}" placeholder="" id="id" name="id">
                </div>
            </div>
            <div class="row col-xs-4 col-sm-4  input_bar">
                <label class="form-label col-xs-4 col-sm-4"> 供货商 </label>
                <div class="row col-xs-7 col-sm-7 ">
                    <y:select id="supplierId" name="supplierId" codeGroup="${proSupplier}"
                              selectedValue="${procurement.supplierId}"
            ...
            <div class="row col-xs-4 col-sm-4  input_bar">
                ...
                <div class="row col-xs-7 col-sm-7 ">
                    <y:select id="storeId" name="storeId" codeGroup="${proStore}" selectedValue="${procurement.storeId}"
                              cssClass="select" headerKey="" headerValue="请选择">
                    </y:select>
                </div>
            </div>
        ...
        <div class="row cl">
            <div class="row col-xs-4 col-sm-4  input_bar">
                ...
                <div class="row col-xs-7 col-sm-7 ">
                    <input type="text" onfocus="WdatePicker()" class="input-text Wdate"
                           value="<fmt:formatDate value="${procurement.procurementTime}" pattern="yyyy-MM-dd"/>"
                           placeholder="" id="procurementDate" name="procurementDate">
            ...
            <div class="row col-xs-4 col-sm-4  input_bar">
                ...
                <div class="row col-xs-7 col-sm-7 ">
                    <y:select id="" name="" codeGroup="[{'id':'1','value':'审核中'},{'id':'2','value':'已完成'}]"
                              selectedValue="${procurement.status}"
                              cssClass="select" headerKey="" headerValue="请选择">
                    </y:select>
                </div>
            </div>
        ...
        <div class="row cl">
            ...
            <div class="row col-xs-9 col-sm-9 input_bar">
                <textarea id="remark" name="remark" placeholder="备注" rows="4"
                          style="width:100%;margin-left: 15px;">${procurement.remark}</textarea>
            </div>
        </div>
        <shiro:hasAnyRoles name="管理员,采购主管">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        var url = "${context_root}/list/getProcurementOrderInfo.action?id=" + GetQueryString('id');
    ...
    $("#form-role-add").validate({
        ...
        submitHandler: function (form) {
            ...
            $.ajax({
                url: "${context_root}/list/checkProcurement.action",
                type: 'post',
                async: true,
                cache: false,
                data: $(form).serialize(),
