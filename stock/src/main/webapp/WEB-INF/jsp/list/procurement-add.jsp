		...
		<div class="row cl">   
			<div class="row col-xs-4 col-sm-4  input_bar"> 
				...
				<div class="row col-xs-7 col-sm-7 ">
					<input type="text" readonly="readonly" class="input-text" value="${procurementNo}" placeholder="" id="id" name="id"> 
			...
			<div class="row col-xs-4 col-sm-4  input_bar"> 
				...
				<div class="row col-xs-7 col-sm-7 ">
					<y:select id="supplierId" name="supplierId" codeGroup="${proSupplier}" selectedValue=""
...
<script type="text/javascript"> 
	...
	$(document).ready(function(){ 
		$.post("${context_root}/product/productCategoryList.action", function(data){ debugger
...
function submitData(){ 
	...
	var index = parent.layer.load();
	 $.ajax({
		url:"${context_root}/list/addProcurementInfo.action", 
		type:'post',
		async:true ,
		cache:false ,
		data:{
