...
<div>
    <div>
        <y:table url="${context_root}/system/userList.action" id="userform" width="100%" sortName="signId"
                 sortOrder="desc" pageSize="20">
            ...
            <y:column width="10%" name="" title='操作' colType="href"
                      colInnerHtml='<a href="#" onclick="detail($T.userId,$T.mobilePhone)">删除</a>'/>
        </y:table>
