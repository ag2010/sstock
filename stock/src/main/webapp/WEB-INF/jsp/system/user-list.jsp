...
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20">
	 <span class="l"><a href="javascript:;" onclick="user_add('添加账号','${context_root}/system/toUserAdd.action','','610')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加账号</a></span>
...
$(document).ready(function(){ 
    ...
    },
    {
        ...
        "mRender": function(data, type, row) {
        	...
        	return  statusTools(row) + "&nbsp;&nbsp;" + toPassword + "&nbsp;&nbsp;" + toEdit ;
        }
    },
    ];
