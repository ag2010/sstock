...
<article class="page-container">
    <form action="" method="post" class="form form-horizontal" id="form-user-add">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-4">
                <input type="text" readonly="readonly" class="input-text" value="${dictionary.name}" placeholder=""
                       name="">
                <input type="hidden" class="input-text" value="${dictionary.dictionaryId}" placeholder=""
                       name="parentId">
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-4">
                <input type="text" class="input-text" value="" placeholder="" name="typeCode">
            </div>
        </div>
        <div class="row cl">
