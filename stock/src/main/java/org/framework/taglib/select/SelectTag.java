...
public class SelectTag extends SimpleTagSupport
{
    ...
    public void doTag() throws JspException, IOException
    {
        ...
        JSONArray ja=null;
        try{
        	if(ObjectUtil.isNotNull(codeGroup) && codeGroup instanceof java.lang.String){
        		ja=JSONObject.parseArray((String)codeGroup);
        	}
        }catch(Exception e){
        	e.printStackTrace();
        }
        ...
        if (ObjectUtil.isNotNull(codeGroup) && codeGroup instanceof java.util.List)
        {
            ...
            { 
                ...
                sysCode.setCodeid((String)((JSONObject)obj).get("id"));
                sysCode.setCodevalue((String)((JSONObject)obj).get("value"));
